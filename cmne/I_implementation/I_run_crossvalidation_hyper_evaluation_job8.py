...
# future steps
training_settings = {'minibatch_size': 30, 'steps_per_ep': 20, 'num_epochs': 250, 'lstm_look_backs': [160], 'num_units': [160,1280], 'future_steps': [1]}
...
fname_cross_validation_idcs_prefix = 'assr_270LP_fs900_cross_idcs_job8_it_'
