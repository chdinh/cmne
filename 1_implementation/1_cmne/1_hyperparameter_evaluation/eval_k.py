#**
# @file     Option_3b_bio_mne_LSTM_single_estimation_lb_eval.py
...
for lstm_look_back in lstm_look_backs:
    ...
    fname_model = settings.repo_path() + 'Results/Models/Model_Opt_3b_' + settings.modality() + '_nu_' + str(num_units) + '_lb_' + str(lstm_look_back) + '_' + date_stamp + '.h5'
    fname_training_loss = settings.repo_path() + 'Results/Training/Loss_Opt_3b_' + settings.modality() + '_nu_' + str(num_units) + '_lb_' + str(lstm_look_back) + '_' + date_stamp + '.txt'
    fname_resultfig = settings.repo_path() + 'Results/img/Loss_Opt_3b_' + settings.modality() + '_nu_' + str(num_units) + '_lb_' + str(lstm_look_back) + '_' + date_stamp + '.png'
...
# save overall plot
date_stamp = datetime.datetime.now().strftime('%Y-%m-%d_%H%M%S')
fname_overall_fig = settings.repo_path() + 'Results/img/Loss_Opt_3b_' + settings.modality() + '_overall_nu_' + str(num_units) + '_lb_' + date_stamp + '.png'
plt.figure()
plt.xlabel('Minibatch number')
plt.ylabel('Loss')
plt.title('Minibatch run vs. Training loss')
